...
public class PurchaseServiceImpl implements PurchaseService {
	...
	public InvoiceResponseDTO getInvoice(Integer invoiceId) {
		...
		List<InvoiceProductDTO> products = orderDetails.stream()
				.map(purchaseMapper::toInvoiceProductDTO)
	...
	public Boolean hasUserPurchasedProduct(Integer userId, String productId) {
		// Buscar las órdenes del usuario que incluyen el producto
		List<OrderDetail> orderDetails = orderDetailRepository.findByOrderUserIdAndProduct(userId, productId);

		// Si encontramos detalles de la orden, significa que el usuario ha comprado el producto
